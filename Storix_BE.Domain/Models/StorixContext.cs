...
public partial class StorixContext : DbContext
{
    ...
    public virtual DbSet<InventoryCountItem> StockCountItems { get; set; }

    public virtual DbSet<InventoryCountsTicket> StockCountsTickets { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<OutboundOrderItem>(entity =>
        {
            ...
            entity.Property(e => e.Price).HasColumnName("price");
            entity.Property(e => e.PricingMethod).HasColumnName("pricing_method");
            entity.Property(e => e.ProductId).HasColumnName("product_id");
            entity.Property(e => e.Quantity).HasColumnName("quantity");
