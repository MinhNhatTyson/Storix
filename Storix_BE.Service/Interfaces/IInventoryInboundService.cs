...
namespace Storix_BE.Service.Interfaces
{
    ...
    {
        Task<int> CreateInboundRequestAsync(CreateInboundRequestRequest request);

        Task<int> UpdateInboundRequestStatusAsync(int ticketRequestId, int approverId, string status);
    }
